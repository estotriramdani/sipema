$(document).ready(function () {
  ...
  const loginForm = `
    <form action="/auth/loginAction" method=POST style="text-align: left;">
  ...
  $(".ganti-guru").click(function () {
    $(".role:eq(0)").replaceWith(
      `<b style="font-weight: bold; transition: 1s;"><u>Guru</u></b>`
    );
  ...
  $(".ganti-siswa").click(function () {
    $(".role:eq(0)").replaceWith(
      `<b style="font-weight: bold; transition: 1s;"><u>Siswa</u></b>`
    );
